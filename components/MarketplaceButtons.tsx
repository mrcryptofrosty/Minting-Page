...
const MarketplaceButtons = (props:any) => {
  ...
  return <div className="flex gap-4 items-center mt-4 w-full justify-center">
    ...
    {/* this repo currently only supports Frosty's editions contract */}
    <Link href={`https://hq.frosty.app/${chain}/Editions/${props.contractAddress}`} target="_blank" rel="noreferrer">
    <Image src="/images/frosty-icon.png" height={18} width={22} alt="frosty"/></Link>
  </div>
}
